              ...
              <div class="col-sm-6 col-sm-offset-3 myform-cont" >
                  ...
                  <div class="col-md-12" >
                   ...
                   <div id="div_notificacion_sol" class="myform-bottom">
                    ...
                    <form   action="{{ url('enviar_productores') }}"  method="post" id="f_enviar_turismo" class="formentrada" >
                      <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      
                        <div class="col-md-12">
                            <div class="form-group">
                                <label >Cuanto ingreso ha generado por su venta?</label>
                                <input type="number" name="ingreso_productores" placeholder="" class="form-control" value="" >
                            </div>
                        </div>
